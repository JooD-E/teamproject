...
<head>
    ...
    <script>
        function request_verify() {
            const hp = document.find_pw_form.hp.value;
            
            if (!hp) {
                alert("휴대폰 번호를 입력해 주세요!");
                document.find_pw_form.hp.focus();
                return;
            }
        ...
        function check_find_pw() {
            if (!document.find_pw_form.id.value) {
                alert("아이디를 입력하세요!");    
                document.find_pw_form.id.focus();
                return;
            }
            if (!document.find_pw_form.name.value) {
                alert("이름을 입력하세요!");    
                document.find_pw_form.name.focus();
                return;
            }
            if (!document.find_pw_form.hp.value) {
                alert("휴대폰 번호를 입력하세요!");    
                document.find_pw_form.hp.focus();
                return;
            }
...
<body>
    ...
    <div class="find-area">
        ...
        <section class="find-container">
            ...
            <div class="form_wrap">
                <form name="find_pw_form" method="post" action="find_pw_process.php">
                    
                    <div class="find-input-row">
                        <label for="findId"><img src="../img/common/login_id_img.png" alt="아이디 아이콘"></label>
                        <input type="text" id="findId" name="id" placeholder="아이디를 입력하세요">
                    </div>
                    ...
                    <div class="find-bottom-btns mt-30">
                        <button type="button" class="btn-find-submit" onclick="check_find_pw()">비밀번호 찾기</button>
