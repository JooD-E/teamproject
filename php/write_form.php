        ...
        <section class="write-area">
            <nav class="archive-util-nav">
                <ul>
                    ...
                    <li><span>&gt;</span></li>
                    <li><span class="nav-span" style="color:#f06a20;">게시글 작성</span></li>
                </ul>
            </nav>
            ...
            <div class="write-container">
                <form action="write_insert.php" method="post" enctype="multipart/form-data" id="boardWriteForm">
                    ...
                    <div class="write-table-top">
                        ...
                        <div class="write-row">
                            ...
                            <input type="text" id="subject" name="subject" class="row-input" placeholder="제목을 입력해주세요 (최대 50자)" maxlength="50" required>
                        </div>

                        <div class="write-row">
                            <span class="row-label">#태그</span>
                            <div class="checkbox-group">
                                <label><input type="checkbox" name="tags[]" value="명반"> #명반</label>
                                <label><input type="checkbox" name="tags[]" value="턴테이블"> #턴테이블</label>
                                <label><input type="checkbox" name="tags[]" value="LP자랑"> #LP자랑</label>
                                <label><input type="checkbox" name="tags[]" value="장비리뷰"> #장비리뷰</label>
                                <label><input type="checkbox" name="tags[]" value="일상TALK"> #일상TALK</label>
                                <label><input type="checkbox" name="tags[]" value="방문후기"> #방문후기</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="write-section">
                        ...
                        <textarea id="content" name="content" class="content-textarea" placeholder="내용을 입력하세요." required></textarea>
                    </div>
